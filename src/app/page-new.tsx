        ...
        <div className="flex-1 flex min-h-0">
          ...
          >
            ...
            <div className="mb-8">
              <div className={`leading-relaxed text-${terminalConfig.fontSize}`}>
                ...
                <div></div>
                <div className={currentTheme.accent}>$ echo 'Use the Real Terminal on the right →'</div>
                <div className={`${currentTheme.text} italic`}>Use the Real Terminal on the right →</div>
              </div>
            </div>
          ...
          >
            ...
            <div className="flex items-center justify-between bg-gray-800 px-4 py-2 border-b border-gray-600 flex-shrink-0">
              <div className={`${isTerminalExpanded ? "block" : "hidden"} text-gray-400 text-sm font-mono`}>Real Terminal</div>
