  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="border-b border-slate-200">
        <div className="max-w-4xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            <div className="text-xl font-bold text-black">Rojasmart</div>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-xl text-black mb-8 max-w-2xl mx-auto">Building modern web applications with clean code and great user experiences.</p>
      ...
      <section id="about" className="bg-slate-50">
        <div className="max-w-4xl mx-auto px-6 py-16">
          <h2 className="text-3xl font-bold text-black mb-8 text-center">About</h2>
      ...
      <section id="services" className="max-w-4xl mx-auto px-6 py-16">
        <h2 className="text-3xl font-bold text-black mb-8 text-center">Services</h2>
      ...
      <footer className="border-t border-slate-200">
        <div className="max-w-4xl mx-auto px-6 py-8 text-center">
          <p className="text-black">© 2025 RojaSmart. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
