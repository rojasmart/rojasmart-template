                      ...
                      <button
                        onClick={() => {
                          const projectsContent = [
                            ...
                            "",
                            "📁 retrosniffer",
                            "   • A price comparator for retro games that automatically scrapes data from different websites.",
                            "   • Using several scrapers in Next.js and Tailwind",
                            "   • 🔗 https://github.com/rojasmart/retrosniffer",
                            "",
                            "📁 note-taking-app",
                            "   • Fullstack note taking app ",
                            "   • Next.js, Tailwind, Node, MongoDB, TypeScript, Express",
                            "   • 🔗 https://github.com/rojasmart/note-taking-app",
                            "",
                            "📁 mathblast",
                            "   • Interactive Math Game app",
                            "   • Next.js, Tailwind, Automated testing,",
                            "   • 🔗 https://github.com/rojasmart/math-game",
                            "",
                            "📁 where-on-earth",
                            "   • Geography quizz application that uses 3D",
                            "   • React, Three JS, CSS-in-JS, Automated testing",
                            "   • 🔗 https://github.com/rojasmart/design-system",
                            "",
                            "📁 pixel-runner",
                            "   • Side-scrolling action game",
                            "   • React, Typescript, Canvas API",
                            "   • 🔗 https://github.com/rojasmart/pixel-runner",
                            "",
                            "📁 kanban-task-management",
                            "   • Fullstack kanban app",
                            "   • React, Tailwind, Apollo, GraphQL, Node, MongoDB, React-beautiful-dnd",
                            "   • 🔗 https://github.com/rojasmart/kanban-task-management-web-app",
                            "",
                            "📁 dictionary-web-app",
                            "   • Dictionary web app",
                            "   • React, Chakra UI, Dictionary API",
                            "   • 🔗 https://github.com/rojasmart/dictionary-web-app",
                            "",
                            "📁 entertainment-app",
                            "   • Entertainment full stack app",
                            "   • React, Chakra UI, Formik, Firebase, Firestore, React-indiana-drag-scroll, TMBD Api",
                            "   • 🔗 https://github.com/rojasmart/entertainment-web-app",
                            "===================================================================",
                            "",
